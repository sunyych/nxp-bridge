...
namespace Plugin.Ndef
{
    ...
    internal class NdefImplementation : INdef
    {
        ...
        async public Task InitTagReaderAsync(TagReaderStatusChanged onTagReaderStatus)
        {
            ...
            MessagingCenter.Subscribe<FormsAppCompatActivity>(this, MessagingCenterMessages.Android.OnCreate, (sender) =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Debug.WriteLine("NA Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                }
            });
            ...
            MessagingCenter.Subscribe<FormsAppCompatActivity>(this, MessagingCenterMessages.Android.OnResume, (sender) =>
            {
                try
                {
                    FormsAppCompatActivity mainActivity = sender;
                    Android.Nfc.NfcAdapter adapter = Android.Nfc.NfcAdapter.GetDefaultAdapter(sender);
                ...
                {
                    Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                    Debug.WriteLine("NB Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                }
            });
            ...
            MessagingCenter.Subscribe<FormsAppCompatActivity>(this, MessagingCenterMessages.Android.OnPause, (sender) =>
            {
                ...
                {
                    Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                    Debug.WriteLine("NC Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                }
            });
            ...
            MessagingCenter.Subscribe<FormsAppCompatActivity, int>(this, MessagingCenterMessages.Android.OnNewAdapterState, (sender, arg) =>
            {
                ...
                {
                    Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                    Debug.WriteLine("ND Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                }
            });
            ...
            MessagingCenter.Subscribe<FormsAppCompatActivity, Intent>(this, MessagingCenterMessages.Android.OnNewIntent, (sender, arg) =>
            {
                ...
                {
                    Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                    Debug.WriteLine("NE Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                }
            });
        ...
        async public Task DeInitTagReaderAsync()
        {
            ...
            {
                Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                Debug.WriteLine("NF Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
            }
        ...
        public async Task<(Status status, List<NdefRecord> rdNdefRecords)> WriteReadAsync(List<NdefRecord> wrNdefRecords)
        {
            ...
            {
                Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                Debug.WriteLine("NG Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
            }
            finally
            {
                if (isSemAcquired)
        ...
        public async Task<(Status status, List<NdefRecord> rdNdefRecords)> ReadAsync()
        {
            ...
            {
                Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                Debug.WriteLine("NH Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
            }
            finally
            {
                if (isSemAcquired)
                ...
                while (!isTerminate)
                {
                    ...
                    switch (index)
                    {
                        case (int)NfcEventIndex.Connect:
                            try
                            {
                                ...
                                if (status == Status.OK && ndefMsg != null && uid != null && tagVer != null)
                                {
                                    ...
                                    TagConnectedEventArgs args = new TagConnectedEventArgs
                                    {
                                        Status = Status.OK,
                            ...
                            {
                                Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                                Debug.WriteLine("NI Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                            }
                            break;
                        ...
                        case (int)NfcEventIndex.WriteReq:
                            ...
                            {
                                Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                                Debug.WriteLine("NJ Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                            }
                            break;
                        ...
                        case (int)NfcEventIndex.ReadReq:
                            ...
                            {
                                Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                                Debug.WriteLine("NKCaught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                            }
                            break;
        ...
        private async Task<Status> WriteNdefMessageAsync(NdefMessage msg)
        {
            ...
            {
                Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                Debug.WriteLine("NL Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
        ...
        {
            (Status status, NdefMessage ndefMsg, byte[] uid, byte[] tagVer) ret = (Status.TagReadFailed, null, null, null);
            ...
            if (isNewTag)
            {
                ...
                try
                {
                    // Read low level info. From the HW documentation:
                    ...
                    mifareUltralight = Android.Nfc.Tech.MifareUltralight.Get(_tag);
                    mifareUltralight.Connect();
                    byte[] tagVer = await mifareUltralight.TransceiveAsync(new byte[] { 0x60 });

                    Android.Nfc.Tech.Ndef ndef = Android.Nfc.Tech.Ndef.Get(_tag);
                    NdefMessage ndefMsg = NdefMessage.FromByteArray(ndef.CachedNdefMessage.ToByteArray());
                ...
                {
                    Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                    Debug.WriteLine("NM Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
            ...
            else
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    try
                    {
                        ...
                        byte[] ndefMsgByteArray = null;
                        Android.Nfc.NdefMessage readData = null;
                        if (ndef != null)
                        {
                            readData = ndef.NdefMessage;
                        }
                        if (readData == null)
                        {
                            /* Tag lost or tag not readable. */
                            Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - Can not read NDEF. Tag lost or tag not readable.");
                            Debug.WriteLine("Can not read NDEF. Tag lost or tag not readable:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod());
                            break;
                        }
                        try
                        {
                            ndefMsg = NdefMessage.FromByteArray(readData.ToByteArray());
                            ndefMsgByteArray = ndefMsg.ToByteArray();
                            Debug.WriteLine($"{DateTime.Now.TimeOfDay} - ReadNdefMessageAsync DATA:" + BitConverter.ToString(ndefMsgByteArray));
                        }
                        catch (NullReferenceException ex)
                        {
                            Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                            Debug.WriteLine("Can not read NDEF: tag lost or tag not readable.");
                        }

                        if ((ndefMsg == null) || (ndefMsgByteArray == null) || _lastNdefMsgByteArray.SequenceEqual(ndefMsgByteArray))
                        {
                            /* No NDEF read or read our own NDEF. Retry. */
                        }
                        else /* done */
                        {
                            _lastNdefMsgByteArray = ndefMsgByteArray;
                            ret.ndefMsg = ndefMsg;
                            ret.status = Status.OK;
                            break;
                        }
                    ...
                    {
                        Helpers.ExceptionLogHelper.Log(_tagIdStr, Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                        Debug.WriteLine("NN Caught exception:" + _tagIdStr + " - " + Helpers.ExceptionLogHelper.GetCurrentMethod() + " - " + ex.Message);
                        break;
                    }
                    finally
                    {
